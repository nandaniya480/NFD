        ...
        <div class="authentication-inner row">
            ...
            <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <form id="form_submit" class="mb-3" action="{{route('verifyEmail')}}" method="POST" data-parsley-validate>
                        @csrf
                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="text" class="form-control" id="email" name="email" placeholder="Enter your email" autofocus data-parsley-required data-parsley-required-message="Please Enter Email" data-parsley-errors-container="#email_error">
